                ...
                <div class="fw-coll m12">
                    <div class="fw-card fw-round fw-white">
                        <div class="fw-container fw-padding">
                            ...
                            <form  name="form" method="POST" action="username-exists.php" class="fw-container fw-card-4" style="margin-top: 20%;">
                                <div>
                                    <p>
                                ...
                                <div class="fw-center">
                                    <p>
                                        <button type="submit" name="submit" class="fw-button fw-section fw-red fw-ripple"> Réinitialiser </button>
                                    </p>
                                </div>
                            </form>
